...
export class Backend implements backendInterface {
    ...
    async getAllProductInquiryCounts(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProductInquiryCounts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContactSubmission(arg0: bigint): Promise<ContactSubmission | null> {
        if (this.processError) {
            try {
    ...
    async getProductInquiryCount(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductInquiryCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<{
        __kind__: "ok";
        ok: bigint;
    } | {
        __kind__: "err";
